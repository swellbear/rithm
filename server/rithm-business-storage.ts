...
export class RithmBusinessStorage implements IRithmBusinessStorage {
  // User management
...
export const rithmBusinessStorage = new RithmBusinessStorage();